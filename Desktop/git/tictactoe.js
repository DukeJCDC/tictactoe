...
function getnames() {
    ...
    return { xname: XPlayer, oname: OPlayer };
};
...
function playGame(XPlayer, OPlayer) {
    while (playing) {
        Winner=false;
        turnNum=0;
    ...
    playGame(playerNames.xname, playerNames.oname); 